/**
 * Authentication routes — OAuth 2.0 Web Server flow with PKCE.
 *
 * The user authenticates on Salesforce's own login page (credentials
...
const CALLBACK_URL = process.env.SF_CALLBACK_URL || 'http://localhost:5001/api/auth/callback';
...
router.get('/callback', async (req, res) => {
  ...
  try {
    ...
    console.log(`Authenticated via OAuth: ${identity.username}`);
