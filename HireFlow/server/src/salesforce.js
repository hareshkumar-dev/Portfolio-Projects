 ...
 *
 * The public careers site — job listings and applications — is served
 * without candidate login. Those operations run against Salesforce
 * under a dedicated integration user configured in .env.
 *
