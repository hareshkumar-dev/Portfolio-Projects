...
// Track a React root per mounted element so the LWC host can cleanly
// unmount when it's removed from the page.
const roots = new WeakMap();

function injectStyles() {
  if (document.head.querySelector('style[data-projectboard]')) return;
  const style = document.createElement('style');
  style.setAttribute('data-projectboard', '');
