/**
 * Authentication routes (admin console) — OAuth 2.0 Web Server flow with PKCE.
 *
 * Organizers authenticate on Salesforce's own login page (credentials
...
const CALLBACK_URL = process.env.SF_CALLBACK_URL || 'http://localhost:5002/api/auth/callback';
...
router.get('/callback', async (req, res) => {
  ...
  try {
    ...
    console.log(`Organizer authenticated via OAuth: ${identity.username}`);
